  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        onMouseEnter: (e) => {
          e.currentTarget.style.background = "var(--dsw-alias-bg-module-platform, rgba(0,0,0,0.04))";
        },
        onMouseLeave: (e) => {
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: childrenStyle(depth), children: node.children.map((child) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      TreeEntry,
      {
        node: child,
        depth: depth + 1,
